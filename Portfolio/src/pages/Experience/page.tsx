      ...
      <div className="@container mx-auto max-w-5xl px-6 relative">
        ...
        >
          ...
          <ExperienceCard
            ...
            company="McCarthy"
            period="2025"
            description="Assisted in backend tasks, handled deployment, and supported project infrastructure."
            icon={<Code />}
          />
          ...
          <ExperienceCard
            ...
            period="2025"
            description="Developed a chatbot as part of a virtual AI internship program."
            icon={<Code />}
          />
        </motion.div>
      </div>
    ...
    >
      <Card
        className={`group h-full ${
          isDark
            ? "bg-black/80 border-gray-700 hover:shadow-blue-500/20"
...
const CardDecorator = ({ children }: { children: ReactNode }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 m-auto flex size-10 items-center justify-center bg-transparent">
        {children}
      </div>
    </div>
  );
