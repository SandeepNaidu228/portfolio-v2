...
const options = [
  {
    ...
    subtitle: "linkedin.com/in/mvnsandeepnaidu",
  ...
  },
  {
    ...
    subtitle: "github.com/SandeepNaidu228",
  ...
  },
  {
    ...
    title: "mvnsandeepsandeep@gmail.com",
    subtitle: "Internships, freelance & opportunities",
...
function LearningBoard() {
  const learningItems = [
  {
    ...
    desc: "Strengthening problem-solving skills through C++ and LeetCode while preparing for software engineering interviews.",
    tags: ["C++", "DSA", "LeetCode", "Problem Solving"],
  ...
  },
  {
    ...
    desc: "Building scalable APIs, authentication systems, microservices, caching layers, and real-time applications using Node.js.",
  ...
  },
  {
    icon: Terminal,
    title: "DevOps & Cloud",
    desc: "Learning Docker, Linux, CI/CD pipelines, AWS fundamentals, and deployment strategies for production systems.",
